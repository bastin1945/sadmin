<header class="flex items-center justify-between px-8 py-4 bg-white border-b-8 border-white">
    ...
    <div class="flex items-center">
         ...
         <div class="flex items-center justify-center w-10 h-10 border-2 border-gray-300 rounded-full bg-white shadow-md">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" class="w-8 h-8 text-gray-700">
            <path d="M12 12c2.5 0 5-2 5-5s-2.5-5-5-5-5 2-5 5 2.5 5 5 5zm0 2c-3 0-9 1.5-9 4.5V22h18v-3.5c0-3-6-4.5-9-4.5z"/>
        </svg>
    </div>
