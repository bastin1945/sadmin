        ...
        <div class="mx-auto max-w-md">
            ...
            <form class="mt-6">
                <div class="relative max-w-lg">
                    ...
                    id="email"
                    type="email"
                    placeholder="Ikuti kami di instagram"
                    />
                    <a href="https://www.instagram.com/" target="_blank" class="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-blue-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-blue-700">
Follow
</a>
