...
<head>
    ...
    <title>Proyek Laravel dengan Tailwind CSS</title>
</head>
        ...
        <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-md">
                ...
                <form class="mt-6">
                    <div class="relative max-w-lg">
                        ...
                        <input class="w-full rounded-full border-gray-200 bg-gray-100 p-4 text-sm font-medium"
                            id="email" type="email" placeholder="Ikuti instagram kami ibstik" readonly />
            ...
            <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                <div class="mx-auto max-w-sm lg:max-w-none">
                    <p class="mt-4 text-center text-black-900 lg:text-left lg:text-lg">
                        Temukan konser musik yang kamu sukai dengan mudah melalui platform kami gengz. Kami menawarkan
                        akses cepat dan aman untuk berbagai konser dari atas ternama di seluruh dunia.

                    </p>

                    <div class="mt-6 flex justify-center gap-4 lg:justify-start">
                        <a class="text-white transition hover:text-blue-700/75" href="#" target="_blank"
                            rel="noreferrer">
                ...
                <div class="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
                    <div>
                        ...
                        <ul class="mt-6 space-y-1">
                            <li>
                                <a class="text-black-900 transition hover:text-gray-700/75" href="#"> Tiket konser
                                </a>
                            </li>
                    ...
                    <div>
                        ...
                        <ul class="mt-6 space-y-1">
                            <li>
                                <a class="text-black-900 transition hover:text-gray-700/75" href="#"> Tentang kami
                                </a>
                            </li>

                            <li>
                                <a class="text-black-900 transition hover:text-gray-700/75" href="#"> Misi kami
                                </a>
                            </li>

                            <li>
                                <a class="text-black-900 transition hover:text-gray-700/75" href="#"> Kenapa
                                    memilih kami? </a>
                            </li>

                            <li>
                                <a class="text-black-900 transition hover:text-gray-700/75" href="#"> Partner
                                    dan kolaborasi </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="mt-6 space-y-1">
                            <li>
                                <a class="text-black-900 transition hover:text-gray-700/75" href="#"> Pusat
                                    bantuan </a>
                            </li>

                            <li>
                                <a class="text-black-900 transition hover:text-gray-700/75" href="#"> Hubungi
                                    kami </a>
                            </li>
            ...
            <div class="mt-16 border-t border-gray-100 pt-8">
                <p class="text-center text-xs/relaxed text-white">
                    ...
                    dan
                    <a href="#" class="text-black-900 underline transition hover:text-gray-700/75">Laravel
                        Livewire</a>.
                </p>
            </div>
        </div>
