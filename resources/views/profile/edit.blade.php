    ...
    <x-app-layout>
        ...
        <div class="flex items-center">
            <button class="bg-gray-600 text-white px-5 py-2 rounded-lg font-semibold hover:bg-gray-800 mr-8" style="width: 200px; height: 50px;">Upload New Photo</button>

            <section class="p-6 bg-white">
                <x-danger-button x-data="" x-on:click.prevent="$dispatch('open-modal', 'confirm-user-deletion')"  class="px-5 py-2 rounded-lg font-semibold text-gray-500" style="width: 200px; height: 50px;">
                    {{ __('Delete') }}
                </x-danger-button>
