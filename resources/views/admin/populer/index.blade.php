<x-admin-layout>
    ...
    <div class="bg-white min-h-screen px-5">
        <div class="flex justify-between items-center px-5 py-5">
            <h1 class="text-2xl font-bold">Atur Populer</h1>
            <a href="{{ route('admin.admin.populer.create', 'populer') }}"
        ...
        @forelse ($populer as $index => $pop)
            <tr class="text-gray-700">
                ...
                <td class="border-b border-gray-300 px-4 py-2 text-center">
                    <form id="delete-form-{{ $pop->id }}" action="{{ route('admin.admin.populer.populers', $pop->id) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
                    ...
                    <div class="flex flex-col items-center justify-center py-8">
                        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200" fill="none" class="mb-5">
                            ...
                            <g transform="translate(75, 70)">
                                <path d="M25,0 L32.5,17.5 L50,20 L37.5,32.5 L40,50 L25,42.5 L10,50 L12.5,32.5 L0,20 L17.5,17.5 Z" fill="#9CA3AF"/>
                            </g>
                        ...
                        <h3 class="text-xl font-semibold text-gray-700 mb-2">Data Konser Populer Kosong</h3>
                        <p class="text-gray-500 text-center mb-6 max-w-md">Tidak ada data konser populer yang tersedia untuk ditampilkan</p>
                        <a href="{{ route('admin.admin.populer.create', 'populer') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-md flex items-center transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clip-rule="evenodd" />
                            </svg>
                            Tambah Konser Populer
                        </a>
                    </div>
                </td>
            </tr>
