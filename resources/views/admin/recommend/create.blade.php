<x-admin-layout>
    <div class="bg-white min-h-screen px-5">
        ...
        <form action="{{ route('admin.admin.populer.store','rekomend') }}" method="POST">
            @csrf
            ...
            <a href="{{ route('admin.recommend.index') }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-400 ml-2">
                Kembali
            </a>
        </form>
    </div>
