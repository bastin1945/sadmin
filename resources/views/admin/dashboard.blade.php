...
<div class="mt-4">
    ...
    <div class="relative flex justify-between items-start px-5 py-3 shadow-sm rounded-lg bg-white">
        <div id="revenue-container">
            ...
            <h2 id="total-revenue" class="mb-2 text-3xl font-bold text-gray-700">{{ number_format($totalRevenue, 2) }}</h2>
            <div class="flex items-center">
                ...
                <div id="percentage" class="mr-1 font-semibold text-green-500">{{ number_format($percentage, 2) }}%</div>
                <div class="text-md font-semibold text-gray-500">Naik dalam 1 minggu</div>
            </div>
        </div>
    ...
    <div class="relative flex justify-between items-start px-5 py-3 shadow-sm rounded-lg bg-white">
        <div>
            ...
            <h2 id="total-active-users" class="mb-2 text-3xl font-bold text-gray-700">{{ $totalActiveUsers }}</h2>
            <div class="flex items-center">
                ...
                <div id="active-users-percentage" class="mr-1 font-semibold text-green-500">{{ number_format($percentage, 2) }}%</div>
                <div class="text-md font-semibold text-gray-500">Naik dalam 1 minggu</div>
            </div>
        </div>
