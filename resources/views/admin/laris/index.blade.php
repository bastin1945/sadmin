<x-admin-layout>
    ...
    <div class="bg-white min-h-screen px-5">
        <div class="flex justify-between items-center px-5 py-5">
            <h1 class="text-2xl font-bold">Atur Paling Laris</h1>
            <div class="flex items-center space-x-4">
                <div class="flex justify-between items-center px-5 py-5">

                    <a href="{{ route('admin.admin.populer.create', 'laris') }}"
        ...
        @forelse ($sales as $index => $pop)
            <tr class="text-gray-700">
                ...
                <td class="border-b border-gray-300 px-4 py-2 text-center">
                    <form id="delete-form-{{ $pop->id }}" action="{{ route('admin.admin.populer.sales', $pop->id) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
                    ...
                    <div class="flex flex-col items-center justify-center py-8">
                        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200" fill="none" class="mb-5">
                            ...
                            <g transform="translate(70, 80)">
                                <path d="M30,0 L30,35 C20,35 10,30 10,15 L10,0 L50,0 L50,15 C50,30 40,35 30,35 Z" fill="#9CA3AF"/>
                                <rect x="20" y="35" width="20" height="8" fill="#9CA3AF"/>
                                <rect x="15" y="43" width="30" height="5" rx="2" fill="#9CA3AF"/>
                                <path d="M10,10 C0,10 0,20 10,20" stroke="#9CA3AF" stroke-width="3" fill="none"/>
                                <path d="M50,10 C60,10 60,20 50,20" stroke="#9CA3AF" stroke-width="3" fill="none"/>
                            </g>
                        ...
                        <h3 class="text-xl font-semibold text-gray-700 mb-2">Data Konser Paling Laris Kosong</h3>
                        <p class="text-gray-500 text-center mb-6 max-w-md">Tidak ada data konser paling laris yang tersedia untuk ditampilkan</p>
                        <a href="{{ route('admin.admin.populer.create', 'laris') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-md flex items-center transition-colors">
