...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="relative bg-white rounded-3xl shadow-2xl flex w-[1150px] h-[550px] overflow-hidden z-100 form-container">
        <div class="w-1/2 flex flex-col justify-center px-10">
            ...
            <h2 class="text-center text-2xl font-bold mb-6 welcome-text">Register for Vibestic</h2>
        ...
        <div class="w-1/2 flex flex-col justify-center text-black px-8 relative">
            ...
            <h2 class="text-2xl font-bold mb-4 welcome-text">Welcome to Vibestic!</h2>
            <p class="text-sm leading-relaxed">
                Sign up and join our vibrant community.<br>
                Create an account to explore all the exciting features.
            </p>
            <div class="absolute bottom-0 w-full">
                <svg viewBox="0 0 1200 120" xmlns="http://www.w3.org/2000/svg" class="moving-path">
